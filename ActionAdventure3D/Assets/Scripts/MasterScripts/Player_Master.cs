...
public class Player_Master : MonoBehaviour 
{
    ...
    public delegate void HealthPotionPickupEventHandler(int healthAmount);
    public event HealthPotionPickupEventHandler EventPickedUpHealthItem;
    ...
    public void CallEventPickedUpHealthItem(int healthAmount)
    {
        if(EventPickedUpHealthItem != null)
        {
            EventPickedUpHealthItem(healthAmount);
        }
    }
}
